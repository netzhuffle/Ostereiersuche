...
var Bild = new Class(
        {
            ...
            eier : null,
            /**
			 * Ob das Bild verfügbar ist (alle Eier des letzten Bildes gefunden)
			 */
            gefunden : false,
            ...
            geklickt : function(event)
            {
	            ...
	            if (projekt.koordinatenModus)
		            this.findeKoordinaten(left, top);
            ...
            findeKoordinaten : function(x, y)
            {
	            if (!this.koordLinks) {
		            ...
		            var zeile = 'new Ei("kringel-schwarz.png", new Text("Name des Textes", "textid"), ' + top + ', '
		                    + left + ', ' + height + ', ' + width + '),';
		            prompt(
		                    "Hier steht nun die Koordinaten-Zeile des Eis zum Kopieren.\nBitte klicke nun den linkesten Punkt des nächsten Eis an.",
		                    zeile);
		            this.koordLinks = null;
		            this.koordRechts = null;
		            this.koordOben = null;
		            this.koordUnten = null;
		            var ei = new Ei("kringel-rot.png", new Text("Ein Aprilscherz", "aprilscherz"), top, left, height,
		                    width);
		            this.eier.push(ei);
		            this.eier.each(function(ei, i)
		            {

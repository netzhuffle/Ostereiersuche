...
web build:
 - http://mootools.net/core/c3ecf48167b548867c582ad8abdfda36

packager build:
 - packager build Core/Class Core/Element Core/Element.Event Core/Element.Dimensions Core/Fx.Tween Core/Cookie Core/JSON Core/DOMReady
...
for(var i in h){f.call(this,i,h[i],true);}},this);}};})();(function(){var j=this.document;var g=j.window=this;var a=navigator.userAgent.toLowerCase(),b=navigator.platform.toLowerCase(),h=a.match(/(opera|ie|firefox|chrome|version)[\s\/:]([\w\d\.]+)?.*?(safari|version[\s\/:]([\w\d\.]+)|$)/)||[null,"unknown",0],d=h[1]=="ie"&&j.documentMode;
...
}};}})();(function(){var i=document.html;var d=document.createElement("div");d.style.color="red";d.style.color=null;var c=d.style.color=="red";d=null;Element.Properties.styles={set:function(k){this.setStyles(k);
...
b.callChain();}.bind(this));return this;}});var Cookie=new Class({Implements:Options,options:{path:"/",domain:false,duration:false,secure:false,document:document,encode:true},initialize:function(b,a){this.key=b;

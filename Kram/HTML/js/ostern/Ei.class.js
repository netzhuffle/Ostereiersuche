...
var Ei = new Class({
	 ...
	 * @param kringel	string	URI des Kringels für das Ei relativ zum Ordner "images"
	 * @param text		Text	Text des Eis
	 * @param top		integer	Abstand des Eizentrums vom oberen Rand des Bildes in px
	 * @param left		integer	Abstand des Eizentrums vom linken Rand des Bildes in px
